...
export function Sidebar({ children, className }: SidebarProps) {
  ...
  // Prevent scroll when dropdowns expand - use useLayoutEffect for synchronous execution
  useLayoutEffect(() => {
    ...
    // Re-enable scrolling after DOM has settled
        ...
        {item.subItems ? (
          ...
          <div
            ...
            onClick={(e) => {
              ...
              // If clicking on an already-opened item, collapse it
              if (isCurrentlyExpanded) {
                toggleExpanded();
                return;
              }

              // Close all other expanded items and open this one
